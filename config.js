...
export default {
   ...
   APIs: {
      xfarr: {
         ...
         keyopenai: {
         key : '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'
      }
   },

   config: {
      axis: [
         'https://sshaxor.my.id/freeconfig/HC/AXIS/AXIS-AUG.hc',
         'https://sshaxor.my.id/freeconfig/HC/AXIS/AXIS-EDU.hc',
         'https://sshaxor.my.id/freeconfig/HC/AXIS/AXIS-GAME.hc',
         'https://sshaxor.my.id/freeconfig/HC/AXIS/AXIS-MUSIC.hc'
        ],
      isat: [
         'https://sshaxor.my.id/freeconfig/HC/ISAT/ISAT-EDU.hc'
        ],
      tsel: [
         'https://sshaxor.my.id/freeconfig/HC/TSEL/TSEL-GAMEMAX.hc',
         'https://sshaxor.my.id/freeconfig/HC/TSEL/TSEL-ILPED.hc',
         'https://sshaxor.my.id/freeconfig/HC/TSEL/TSEL-OPOK.hc'
        ],
      xl: [
         'https://sshaxor.my.id/freeconfig/HC/XL/XL-EDU.hc',
         'https://sshaxor.my.id/freeconfig/HC/XL/XL-AKRAB.hc',
         'https://sshaxor.my.id/freeconfig/HC/XL/XL-FLEX.hc'
        ],
      udp: [
         'https://sshaxor.my.id/freeconfig/HC/UDP-SSHAXOR.hc'
        ]
   },
   ...
   options: {
      ...
      owner: ["6282125388500"], // set owner number on here
   ...
   Exif: {
      packId: "https://sshaxor.com",
      packName: `Created By :`,
      packPublish: "Dedi Humaedi.",
      packEmail: "admin0@sshaxor.com",
      packWebsite: "https://sshaxor.com",
